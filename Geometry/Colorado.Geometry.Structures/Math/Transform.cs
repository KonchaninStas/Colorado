...
namespace Colorado.Geometry.Structures.Math
{
    ...
    public class Transform : ICloneable, ITransform
    {
        ...
        public double Scale
        {
            get
            {
                return System.Math.Sqrt(this[0, 0] * this[0, 0] + this[1, 1] * this[1, 1] + this[3, 2] * this[3, 2]);
            }
        }

        public ITransform GetRotationTransform()
        {
            ITransform rotationTransform = Clone();
        ...
        public static ITransform CreateRotationX(double rotationAngleInRadians)
        {
            double cos = System.Math.Cos(rotationAngleInRadians);
            double sin = System.Math.Sin(rotationAngleInRadians);
        ...
        /// <returns>The rotation matrix.</returns>
        public static ITransform CreateRotationY(double rotationAngleInRadians)
        {
            double cos = System.Math.Cos(rotationAngleInRadians);
            double sin = System.Math.Sin(rotationAngleInRadians);
        ...
        /// <returns>The rotation matrix.</returns>
        public static ITransform CreateRotationZ(double rotationAngleInRadians)
        {
            double cos = System.Math.Cos(rotationAngleInRadians);
            double sin = System.Math.Sin(rotationAngleInRadians);
        ...
        public static ITransform CreateFromAxisAngle(Vector rotationAxis, double rotationAngleInRadians)
        {
            ...
            double sa = (double)System.Math.Sin(rotationAngleInRadians);
            double ca = (double)System.Math.Cos(rotationAngleInRadians);
            double xx = x * x;
            double yy = y * y;
            double zz = z * z;
            double xy = x * y;
        ...
        public static ITransform Identity()
        {
        ...
        public static ITransform CreateScale(double xScale, double yScale, double zScale)
        {
            ITransform result = Identity();
        ...
        public static ITransform CreateScale(double scale)
        {
            ITransform result = Identity();
        ...
        {
            ITransform openGLTransform = Identity();
        ...
        public ITransform Multiply(ITransform anotherOne)
        {
        ...
        public IQuaternion ToQuaternion()
        {
            double trace = this[0, 0] + this[1, 1] + this[2, 2];

            if (trace > 0.0)
            {
                double s = (double)System.Math.Sqrt(trace + 1.0);
                double w = s * 0.5;
                s = 0.5 / s;
            ...
            else
            {
                ...
                {
                    double s = (double)System.Math.Sqrt(1.0f + this[0, 0] - this[1, 1] - this[2, 2]);
                    double invS = 0.5 / s;
                    return new Quaternion(
                        0.5 * s,
                ...
                {
                    double s = (double)System.Math.Sqrt(1.0f + this[1, 1] - this[0, 0] - this[2, 2]);
                    double invS = 0.5 / s;
                ...
                {
                    double s = (double)System.Math.Sqrt(1.0f + this[2, 2] - this[0, 0] - this[1, 1]);
                    double invS = 0.5 / s;
                    return new Quaternion(
                        (this[2, 0] + this[0, 2]) * invS,
                        (this[2, 1] + this[1, 2]) * invS,
